...
public class AppRTCAudioManager {
  ...
  private class WiredHeadsetReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      Log.d(TAG, "WiredHeadsetReceiver.onReceive" + org.appspot.apprtc.util.AppRTCUtils.getThreadInfo() + ": "
  ...
  private AppRTCAudioManager(Context context) {
    ...
    org.appspot.apprtc.util.AppRTCUtils.logDeviceInfo(TAG);
  }
  ...
  private void setAudioDeviceInternal(AudioDevice device) {
    ...
    org.appspot.apprtc.util.AppRTCUtils.assertIsTrue(audioDevices.contains(device));
